 ...
 * For each case, the 1st line contains the original string, and the 2nd line contains the typed-out string.
 * Each string contains no more than 80 characters which are either English letters [A-Z]
 * (case insensitive), digital numbers [0-9], or "_" (representing the space).
